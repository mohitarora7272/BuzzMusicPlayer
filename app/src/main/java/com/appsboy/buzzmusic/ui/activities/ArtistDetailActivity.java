package com.appsboy.buzzmusic.ui.activities;
...
import com.appsboy.buzzmusic.adapter.album.HorizontalAlbumAdapter;
import com.appsboy.buzzmusic.adapter.song.ArtistSongAdapter;
...
import com.appsboy.buzzmusic.lastfm.rest.LastFMRestClient;
import com.appsboy.buzzmusic.lastfm.rest.model.LastFmArtist;
import com.appsboy.buzzmusic.loader.ArtistLoader;
import com.appsboy.buzzmusic.misc.SimpleObservableScrollViewCallbacks;
...
public class ArtistDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    private void loadArtistImage(final boolean forceDownload) {
        ...
        Glide.with(this)
                ...
                .into(new AlphaMusicColoredTarget(artistImage) {
                    @Override
                    public void onColorReady(int color) {
                        int colorNew = ThemeStore.primaryColorDark(ArtistDetailActivity.this);
                        setColors(colorNew);
                    }
                });
    }
    ...
    private void setColors(int color) {
        ...
        artistImage.setBackgroundColor(ThemeStore.primaryColor(ArtistDetailActivity.this));
