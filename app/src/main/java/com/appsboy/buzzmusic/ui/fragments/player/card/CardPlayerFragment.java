package com.appsboy.buzzmusic.ui.fragments.player.card;
...
import com.appsboy.buzzmusic.adapter.song.PlayingQueueAdapter;
import com.appsboy.buzzmusic.dialogs.LyricsDialog;
import com.appsboy.buzzmusic.dialogs.SongShareDialog;
import com.appsboy.buzzmusic.helper.MusicPlayerRemote;
import com.appsboy.buzzmusic.helper.menu.SongMenuHelper;
import com.appsboy.buzzmusic.model.Song;
import com.appsboy.buzzmusic.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.appsboy.buzzmusic.ui.fragments.player.AbsPlayerFragment;
import com.appsboy.buzzmusic.ui.fragments.player.PlayerAlbumCoverFragment;
import com.appsboy.buzzmusic.util.MusicUtil;
import com.appsboy.buzzmusic.util.Util;
import com.appsboy.buzzmusic.util.ViewUtil;
import com.appsboy.buzzmusic.views.WidthFitSquareLayout;
...
public class CardPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private void updateQueue() {
        ...
        playerQueueSubHeader.setTextColor(ThemeStore.primaryColorDark(getActivity()));
...
//                                    .setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            animatorSet.setDuration(ViewUtil.ALPHAMUSIC_ANIM_TIME);
            return animatorSet;
        }
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public void init() {
            ...
            currentSongViewHolder.image.setScaleType(ImageView.ScaleType.CENTER_CROP);
            int colorIcon = ThemeStore.primaryColorDark(fragment.getActivity());
            ...
            currentSongViewHolder.image.setColorFilter(colorIcon);
            currentSongViewHolder.image.setImageResource(R.drawable.ic_queue_music_white_24dp);
