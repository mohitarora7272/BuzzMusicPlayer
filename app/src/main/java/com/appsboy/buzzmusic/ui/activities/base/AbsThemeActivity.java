    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!ThemeStore.isConfigured(this, 1)) {
            ThemeStore.editTheme(this)
                    ...
                    .primaryColorRes(R.color.md_purple_700)
                    .accentColorRes(R.color.md_purple_800)
                    .commit();
        }
        getSharedPreferences("[[kabouzeid_app-theme-helper]]", 0).edit().putInt("activity_theme", PreferenceUtil.getInstance(this).getGeneralTheme()).apply(); // TEMPORARY FIX
