...
import com.appsboy.buzzmusic.adapter.song.AlbumSongAdapter;
...
import com.appsboy.buzzmusic.lastfm.rest.model.LastFmAlbum;
import com.appsboy.buzzmusic.loader.AlbumLoader;
...
import com.appsboy.buzzmusic.ui.activities.tageditor.AlbumTagEditorActivity;
...
public class AlbumDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album> {
        ...
        SongGlideRequest.Builder.from(Glide.with(this), getAlbum().safeGetFirstSong())
                ...
                .into(new AlphaMusicColoredTarget(albumArtImageView) {
                    ...
                    public void onColorReady(int color) {
                        int colorNew = ThemeStore.primaryColorDark(AlbumDetailActivity.this);
                        setColors(colorNew);
                    }
                });
    }
    ...
    private void setColors(int color) {
        ...
        albumArtImageView.setBackgroundColor(ThemeStore.primaryColor(AlbumDetailActivity.this));
