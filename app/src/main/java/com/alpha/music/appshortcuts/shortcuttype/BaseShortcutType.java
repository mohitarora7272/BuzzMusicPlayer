package com.alpha.music.appshortcuts.shortcuttype;
...
import com.alpha.music.appshortcuts.AppShortcutLauncherActivity;
...
public abstract class BaseShortcutType {
    ...
    static final String ID_PREFIX = "com.alpha.music.appshortcuts.id.";
